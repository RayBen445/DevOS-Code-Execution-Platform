      ...
      <header className="relative max-w-4xl mx-auto px-6 pt-14 pb-10">
        ...
        >
              ...
              <span
                className={
                  org.isPublic
                    ...
                    : "flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full bg-white/5 text-white/30 border border-white/10"
                }
              >
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="flex items-center gap-1.5 px-4 py-2 rounded-2xl bg-white/5 border border-white/10 text-xs font-bold text-white/50">
