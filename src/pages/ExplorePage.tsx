    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col">
      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-6 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/40 text-sm">Discover trending projects and developers on DevOS.</p>
        </div>
...
function ProjectCard({ project, rank }: { project: Project; rank: number }) {
  return (
    <div className="p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-white/20 transition-all group flex flex-col">
...
function DevCard({ user, rank }: { user: UserProfile & { followerCount: number }; rank: number }) {
  ...
  return (
    <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-white/20 transition-all">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div>
        ...
        <div className="space-y-2">
          {topDevs.map((u, i) => (
            <div key={u.uid} className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5 hover:border-white/15 transition-all">
              <RankBadge rank={i + 1} />
      ...
      <div>
        ...
        <div className="space-y-2">
          {topProjects.map((p, i) => (
            <div key={p.id} className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5 hover:border-white/15 transition-all">
              <RankBadge rank={i + 1} />
              <div className="flex-1 min-w-0">
