        ...
        {isMobileMenuOpen && (
          <>
            ...
            {/* Drawer */}
              ...
              className="fixed top-0 right-0 h-[100dvh] w-[85%] max-w-sm bg-base/95 backdrop-blur-3xl border-l border-white/10 z-50 flex flex-col md:hidden shadow-2xl"
            >
              <div className="flex items-center justify-between px-6 py-5 border-b border-white/5 flex-shrink-0">
                ...
                <button
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="w-8 h-8 flex items-center justify-center rounded-xl bg-white/5 text-white/50 hover:text-white transition-colors"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
                  ...
                  <div className="space-y-1">
                    ...
                    {isAdmin && (
                      <Link
                        to="/admin"
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="flex items-center gap-4 px-4 py-3 rounded-xl bg-red-500/10 text-red-400 hover:bg-red-500/20 transition-all text-sm font-bold"
                      >
                        <ShieldCheck className="w-4 h-4" />
                        Admin
                      </Link>
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <button
                          ...
                          className={cn(
                            "w-full flex items-center gap-4 px-4 py-3 rounded-xl transition-all text-sm text-left font-medium",
                            context?.type === "user" || !context
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-white/5 text-white/70 hover:text-white transition-all text-sm text-left font-medium"
                        >
                          <Gift className="w-4 h-4" />
                          Redeem Code
                        </button>
                          ...
                          <div className="pt-2 mt-2 border-t border-white/5">
                            {savedAccounts.filter((a) => a.uid !== user?.uid).map((acc) => (
                              <button
                                ...
                                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/5 text-white/70 hover:text-white transition-all text-sm text-left disabled:opacity-50 font-medium"
                              >
              ...
              <div className="px-5 py-5 border-t border-white/5 bg-black/20 flex-shrink-0">
                {user ? (
                  <button
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white transition-all text-sm font-bold"
                  >
                    <LogIn className="w-4 h-4" />
                    Sign In
                  </button>
